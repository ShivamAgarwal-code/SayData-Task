            ...
            <div className="navbar"   >
                <div className="Nav-items">
                    ...
                    <div className="Nav-Corner">
                        <div className="NotificationIcon" style={{cursor:"pointer"}} onClick={() =>{setShowDropdown(!showDropdown)}} > {<div className="badge">{props.notificationRecords.length}</div>} <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" >
